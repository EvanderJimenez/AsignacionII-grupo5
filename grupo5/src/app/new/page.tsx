  ...
  return (
    <div className="flex justify-center items-center h-full">
      <form className="bg-gray-700 p-10" onSubmit={onSubmit}>
        <h1 className="text-3xl mb-3">{params.id ? "Editar Tarea" : "Nueva Tarea"}</h1>
        <input
          type="text"
        ...
        <button className="bg-blue-500 hover:bg-blue-400 px-4 py-2 rounded-sm disabled:opacity-30">Guardar</button>
      </form>
    </div>
  );
};
